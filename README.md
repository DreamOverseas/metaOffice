# Meta Office Online ![License](https://img.shields.io/badge/license-MIT-blue) 

This project is based on the open-source project - [SkyOffice](https://github.com/kevinshen56714/SkyOffice) <br>
Thanks for their contribution to the open-source community! <br>
Thus this will also be a open-source project but with edits to the original one.
<br><br>
Works on all PC browsers (mobile browsers are currently not supported)...

## Built with

- [Phaser3](https://github.com/photonstorm/phaser) - ParserGame engine
...
Thanks again for for SkyOffice team for boosting up this project, appriciated for contribution to the open-source community. If you condition also meets, maybe consider [get them a coffee](https://www.buymeacoffee.com/skyoffice). Thank you :)
